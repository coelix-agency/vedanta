...
class BeRocket_AAPF_custom_sidebar {
    function __construct() {
        ...
        if ( ! is_admin() ) {
            ...
            add_action('wp_footer', array( $this, 'wp_footer_sidebar' ));
    ...
    function settings_page($data) {
        $data['Design']['custom_sidebar'] = array(
    ...
    public function section_custom_sidebar() {
        ...
        $html = '
            <hr />
            <h3>' . __('Custom Sidebar Styles', 'BeRocket_AJAX_domain') . '</h3>
                            ...
                            <div class="berocket_group_is_hide_theme_option_slider slider_shadow">';
                                $html .= '
                                    <div>
                                        ...
                                        <label for="sidebar_shadow_theme_"><img src="' . plugin_dir_url(BeRocket_AJAX_filters_file) . 'images/themes/sidebar-shadow/default.png" /></label>
                                    </div>';
                                for ( $theme_key = 1; $theme_key <= 2; $theme_key++ ) {
                                    $html .= '
                                    <div>
                                        ...
                                        <label for="sidebar_shadow_theme_' . $theme_key . '"><img src="' . plugin_dir_url(BeRocket_AJAX_filters_file) . 'images/themes/sidebar-shadow/' . $theme_key . '.png" /></label>
                                    </div>';
                                }
                                $html .= '
                            </div>
