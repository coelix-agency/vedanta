...
<script>
    ...
    function berocket_show_above_option() {
        if( jQuery('.berocket_show_above_option').prop('checked') ) {
            jQuery('.berocket_group_is_hide_option_data').show();
        } else {
            jQuery('.berocket_group_is_hide_option_data').hide();
            jQuery('.berocket_group_is_hide_option').removeAttr('checked');
            jQuery('.berocket_group_is_hide_theme_option_data').hide();
            jQuery('.berocket_group_is_hide_theme_option').removeAttr('checked');
        }
    }
    jQuery(document).on('change', '.berocket_show_above_option', berocket_show_above_option);
    berocket_show_above_option();
