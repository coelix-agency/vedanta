jQuery(function( $ )
{
    ...
    alert('d00');
		$( '.wp-list-table.tags tbody, .attributes-tabl tbody' ).sortable({
			...
			stop: function( event, ui ) {
				...
				$( '.wp-list-table.tags tbody tr:not(.inline-edit-row), .attributes-tabl tbody tr:not(.inline-edit-row)' ).each( function( i, e ) {
